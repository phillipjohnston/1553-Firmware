...
xst -ifn xst.scr
move Clock_2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock_2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock_2_exdes.ucf Clock_2_exdes

echo 'Running map'
map -timing -pr b Clock_2_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm Clock_2_exdes -w routed.ncd routed.vhd
cd ..
